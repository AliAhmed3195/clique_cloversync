...
gulp.task('html', ['inject', 'partials'], function () {
  ...
  return gulp.src(paths.tmp + '/serve/*.html')
    ...
    .pipe($.replace('TRI_TIMESTAMP', new Date().getTime()))
...
gulp.task('assetslib', function () {
  return gulp.src(paths.src + '/assets/lib/**/*')
    .pipe(gulp.dest(paths.dist + '/assets/lib/'));
});
gulp.task('assetsTemplates', function () {
  
  return gulp.src(paths.src + '/assets/*.html')
...
gulp.task('buildapp', ['html', 'images', 'fonts', 'translations', 'misc', 'data', 'examplejs','assetslib','assetsTemplates']);
//gulp.task('buildapp', ['assetslib','assetsTemplates']);
