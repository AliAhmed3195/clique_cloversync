(function() {
    ...
    /* @ngInject */
    function DefaultToolbarController($scope, $injector, $rootScope, $mdMedia, $state, $element, $filter, $mdUtil, $mdSidenav, $mdToast, $timeout, $document, triBreadcrumbsService, triSettings, triLayout,Clique,$window) {
        var vm = this;
        ...
        vm.currentUser = {
                displayName: Clique.getUserName(),
                username: Clique.getUserName(),
                avatar: 'assets/images/avatars/avatar-5.png',
                roles: []
            };
