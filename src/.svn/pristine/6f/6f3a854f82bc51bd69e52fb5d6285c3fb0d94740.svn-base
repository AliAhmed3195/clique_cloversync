(function() {
    ...
    function countupto($timeout) {
        ...
        function link($scope, $element, attrs) {
            ...
            attrs.decimals = angular.isUndefined(attrs.decimals) ? 1 : parseFloat(attrs.decimals);
            attrs.duration = angular.isUndefined(attrs.duration) ? 1 : parseFloat(attrs.duration);
